...
CSV/JSON import preview, client validation, and export downloads.
...
- `previewEndpoint` → default `/imports/preview`; `exportEndpoint` → default `/exports/jobs` when `runtimeConfig.ssma.baseUrl` is set.
