import { DEFAULT_ENDPOINTS, DEFAULT_STORAGE, ROLE_ORDER, METHOD_BY_FLOW, now, isPlainObject, normalizeStrategy, normalizeMethod, parseJsonSafe, createStorageAdapter, createMemoryStorageAdapter, mergeOptions, safeParseResponseBody, randomState, buildUser, buildAccessToken, buildSessionId, buildRole, buildProvider, buildExpiresAt, buildRequestId, resolveCallbackInput } from './authUtils.js';
