...
Comment list UI, optimistic submit/edit/delete states, and moderation labels.
...
- `endpoint` → default `/comments`; `moderationEndpoint` → default `/comments` when `runtimeConfig.ssma.baseUrl` is set.
