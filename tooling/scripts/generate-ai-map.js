...
async function parseContracts() {
    try {
        const contractsPath = path.join(projectRoot, 'library/runtime/Contracts.js');
...
async function generateMap() {
    ...
    const structure = await scanDirectory(path.join(projectRoot, 'library'));
    ...
    const aiSystemMap = {
        ...
        runtime: {
            ...
            observability: {
                localDiagnostics: {
                    ...
                    files: [
                        'library/runtime/LogAccumulator.js',
                        'library/runtime/ErrorBoundary.js',
                        'library/runtime/diagnosticSnapshot.js'
                    ],
                    responsibilities: [
                ...
                outboundTelemetry: {
                    ...
                    files: [
                        'library/modules/analytics/services/AnalyticsService.js',
                        'library/modules/analytics/services/EventClassifier.js',
                        'library/modules/analytics/services/EventAggregator.js',
                        'library/modules/analytics/services/SecurityScanner.js',
                        'library/modules/analytics/consent/ConsentService.js',
                        'library/runtime/seoAudit.js'
                    ],
                    responsibilities: [
        ...
        observability: {
            split: {
                diagnostics: 'library/runtime/LogAccumulator.js',
                telemetry: 'library/modules/analytics/services/AnalyticsService.js'
            },
            consent: {
                service: 'library/modules/analytics/consent/ConsentService.js',
                storageKey: 'csma.analyticsConsent.v1',
                scopes: ['ui_analytics', 'performance', 'error_tracking', 'security']
            },
            seo: {
                audit: 'library/runtime/seoAudit.js',
                snapshot: 'library/runtime/diagnosticSnapshot.js'
            },
            tests: [
        ...
        integrations: {
            ssma: {
                aiProvider: {
                    file: 'library/modules/ai/providers/SSMAGatewayProvider.js',
